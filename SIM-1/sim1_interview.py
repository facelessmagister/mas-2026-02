#!/usr/bin/env python3
"""
SIM-1 Agent Interview Tool

Load a persona from sim1_personas.json and conduct an interactive interview
...
Usage:
    ...
    python3 sim1_interview.py --agent agent_0006
...
API_KEY = "ollama"
PERSONAS_PATH = Path("/root/projects/mas-2026-02/SIM-1/sim1_personas.json")
...
def load_personas() -> List[Dict[str, Any]]:
    if not PERSONAS_PATH.exists():
        ...
        print("Run sim1_engine.py first to generate personas.")
        sys.exit(1)
...
def interview_agent(persona: Dict[str, Any]) -> None:
    ...
    system_msg = (
        ...
        "You have just completed a simulation of Malaysia's doctor shortage crisis (2026-2030). "
...
# ---------------------------------------------------------------------------
def main():
    parser = argparse.ArgumentParser(description="Interview SIM-1 agents after simulation.")
    ...
    if not args.agent:
        print("Usage: python3 sim1_interview.py --agent 'Dr Lim Kah Wai'")
        print("       python3 sim1_interview.py --list")
        sys.exit(1)
